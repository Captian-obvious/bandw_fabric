...
public class LaserTurretEntityModel extends EntityModel<LaserTurretEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r5 = barrel.addChild("cube_r5", ModelPartBuilder.create().uv(32, 16).cuboid(-11.0F, 1.0F, -1.0F, 12.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, -1.7453F, 0.0F, 0.0F));

		ModelPartData cube_r6 = barrel.addChild("cube_r6", ModelPartBuilder.create().uv(32, 12).cuboid(-11.0F, 1.0F, -1.0F, 12.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, -2.618F, 0.0F, 0.0F));

		ModelPartData cube_r7 = barrel.addChild("cube_r7", ModelPartBuilder.create().uv(32, 8).cuboid(-11.0F, 1.0F, -1.0F, 12.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, 2.618F, 0.0F, 0.0F));

		ModelPartData cube_r8 = barrel.addChild("cube_r8", ModelPartBuilder.create().uv(32, 4).cuboid(-11.0F, 1.0F, -1.0F, 12.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, 1.7453F, 0.0F, 0.0F));

		ModelPartData cube_r9 = barrel.addChild("cube_r9", ModelPartBuilder.create().uv(32, 0).cuboid(-11.0F, 1.0F, -1.0F, 12.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, 0.0F, 0.8727F, 0.0F, 0.0F));
