...
public class ModEntityRenderers {
    public static void registerEntityRenderers() {
        DefianceClient.LOGGER.info("Registering entity renderers for " + DefianceClient.MOD_ID);
        ...
        EntityRendererRegistry.register(ModEntities.LASER_TURRET, (EntityRendererFactory.Context context) -> new LaserTurretEntityRenderer(context));
    };
};
