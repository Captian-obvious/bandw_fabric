...
public class ModItems {
    ...
    public static final FoodComponent dark_rotten_flesh_food_component=new FoodComponent.Builder().nutrition(4).saturationModifier(0.3f).build();
    ...
    public static final SwordItem blade_of_infinite_sorrow=new BladeOfInfiniteSorrow(ToolMaterial.DIAMOND,15,-2.4F,new Item.Settings().registryKey(blade_of_infinite_sorrow_key).enchantable(true));
    ...
    public static final SwordItem blade_of_karma=new BladeOfKarma(ToolMaterial.DIAMOND,10,-2.4F,new Item.Settings().registryKey(blade_of_karma_key).enchantable(true));
