...
public class ModDamageSources {
    ...
    public static final RegistryKey<DamageType> PURE_DIVINITY_STRIKE = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.of(Defiance.MOD_ID, "pure_divinity_strike"));
